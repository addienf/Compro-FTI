...
@section('content')
    ...
    <div class="body" id="content">
        ...
        <div class="options-container">
            ...
            @auth
                <a type="button" class="option active-option" data-bs-toggle="modal" data-bs-target="#addKjI">Tambah
                    Kegiatan</a>
            @endauth
        </div>
                                ...
                                <div class="modal fade" id="editModal{{ $kj->IdKerjasama }}" tabindex="-1"
                                    ...
                                    <div class="modal-dialog">
                                        <div class="modal-content">
                                            ...
                                            <form action="{{ route('KerjasamaI.Update', $kj->IdKerjasama) }}"
                                                ...
                                                <div class="modal-body">
                                                    ...
                                                    <div class="form-check">
                                                        ...
                                                        <input class="form-check-input" type="checkbox"
                                                            name="Tridarma[2]" id="flexCheckbox1"
                                                            {{ $kj->Tridarma2 ? 'checked' : '' }}>
                                                        <label class="form-check-label d-flex flex-start"
                                                            for="flexCheckbox2">
                                                            Tridarma2
                                                        </label>
                                                        <input class="form-check-input" type="checkbox"
                                                            name="Tridarma[3]" id="flexCheckbox1"
                                                            {{ $kj->Tridarma3 ? 'checked' : '' }}>
                                                        <label class="form-check-label d-flex flex-start"
                                                            for="flexCheckbox3">
                                                            Tridarma3
                                                        </label>
        ...
        <div class="modal fade" id="addKjI" tabindex="-1" aria-labelledby="addKjILabel" aria-hidden="true">
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <form action="addKjI" method="POST" enctype="multipart/form-data">
                        <div class="modal-body">
                            @csrf
                            <div class="mb-3">
