        ...
        <div class="body">
            ...
            <div class="card-container">
                <div class="card" style="">
                    <img src="{{ asset('img\Rectangle 175 (4).png') }}" class="card-img-top" alt="...">
                    <div class="card-body">
                        <h5 class="card-title">Judul</h5>
                        <p class="card-text">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Quidem consequuntur
                            quibusdam cupiditate impedit cum. Dicta accusamus eveniet officiis sed fugiat animi ipsum
                            laboriosam
                ...
                <div class="card" style="">
                    <img src="{{ asset('img\Rectangle 175 (5).png') }}" class="card-img-top" alt="...">
                    <div class="card-body">
                        <h5 class="card-title">Judul</h5>
                        <p class="card-text">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Quidem consequuntur
                            quibusdam cupiditate impedit cum. Dicta accusamus eveniet officiis sed fugiat animi ipsum
                ...
                <div class="card" style="">
                    <img src="{{ asset('img\Rectangle 175 (6).png') }}" class="card-img-top" alt="...">
                    <div class="card-body">
                        <h5 class="card-title">Judul</h5>
                        <p class="card-text">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Quidem consequuntur
                            quibusdam cupiditate impedit cum. Dicta accusamus eveniet officiis sed fugiat animi ipsum
